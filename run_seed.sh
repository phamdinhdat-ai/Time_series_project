...
do
    python main.py --model_type adaptive_lstm --data_type static --scenario person_divide --num_classes 12 --epochs 200 --sequence_length 100 --overlap 0.4 --batch_size 512 --loss_fn nll  --normalizer batch_norm --seed $i

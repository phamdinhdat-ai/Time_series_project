...
def parse_opt(known=False):
    ...
    parser.add_argument('--kernel_size', type=int, default=3, help='window_size across samples')
    parser.add_argument('--filters', type=int, default=8, help='numbers of filters in convolution')
    parser.add_argument('--strides', type=float, default=1, help='overlap of window across samples')
